...
const PASSIVE_REGEN: float = 20.0  # 2026-06-14 三次微调:每秒被动恢复 20(60→15→20)

@export var max_focus: float = 600.0  # 2026-06-14 二次微调:上限 600(1500→1000→600)

var current: float = 600.0
